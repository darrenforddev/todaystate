...
import TodayScorePortfolioPanel from "./TodayScorePortfolioPanel";
...
export default function TodayScoreScreener({
  ...
  return (
    <div className="mt-8">
        ...
        <aside className="h-fit rounded-3xl border border-slate-700/70 bg-[#07111f] p-5 2xl:sticky 2xl:top-6">
          ...
          <div className="mt-6 space-y-5 border-t border-slate-800 pt-5">
            ...
            <RangeFilter
              ...
              onChange={(value) =>
                updateFilter("minimumThemeConfidence", value)
              }
            />
            <RangeFilter
                  ...
                  {filteredCompanies.map((company, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-3 py-5">
                          <ScoreCell
                            value={company.result.todayScore.quality}
                          />
                        </td>
                        <td className="px-3 py-5">
                        ...
                        <td className="px-3 py-5">
                          <ScoreCell
                            value={company.result.todayScore.momentum}
                          />
                        </td>
                        <td className="px-3 py-5">
      ...
      <TodayScorePortfolioPanel companies={filteredCompanies} />
    </div>
  );
}
